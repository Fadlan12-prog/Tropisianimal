    ...
    <section class="sec4-1">
        <div class="container">
            <div class="row">
                ...
                <table>
                    <tr>
                      <th rowspan="2"><img src="../img/gajah.png" class="gajah-img"></th>
                      <td><img src="../img/badak.png" class='badak-img'></td>
                    </tr>
                    <tr>
                      <td><img src="../img/kudanil2.png" class="kudanil-img"></td>
                    </tr>
                </table>
                </div>
                <div class="col new-col">
                    <h2 class="lh-base fw-bold">10 Hewan Herbivora<br> Yang Berbahaya</h2>
